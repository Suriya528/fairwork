          ...
          <div className="mt-3.5 flex flex-wrap items-center gap-2 pt-2 text-xs text-muted">
            ...
            {[
              ...
              <Link
                key={tag}
                to={destination}
                className="rounded-full border border-border bg-surface px-3 py-1 text-xs text-muted transition-colors hover:border-border-strong hover:bg-elevated hover:text-foreground"
              >
                {tag}
              </Link>
            ))}
