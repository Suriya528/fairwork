...
export const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Contracts", path: "/admin/contracts", icon: FiCheckSquare },
      { label: "Escrows", path: "/admin/escrows", icon: FiShield },
      { label: "Disputes", path: "/admin/disputes", icon: FiAlertTriangle },
      { label: "Transactions", path: "/admin/transactions", icon: FiList },
      { label: "Reports", path: "/admin/reports", icon: FiFlag },
      { label: "Audit Logs", path: "/admin/audit-logs", icon: FiLock },
      { label: "Analytics", path: "/admin/analytics", icon: FiBarChart2 },
      { label: "System & Integrity", path: "/admin/system", icon: FiActivity },
    ],
  },
]
